...
- **Translations (i18n):** TaskMan is a multi-language app. Any new text that a user will see MUST be translatable. Use `gettext_lazy` for this:
...
If you cannot translate - that is fine.
Just make sure all new strings are wrapped with _() or {% trans %}.
The maintainer will handle missing translations.
